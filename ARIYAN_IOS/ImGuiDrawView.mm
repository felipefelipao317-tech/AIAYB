...
Attach();
   ...
   char* Gnam = (char*) [[NSString stringWithFormat:nssoxorany("GOAT XITERS"), ver] cStringUsingEncoding:NSUTF8StringEncoding];
...
ImGui::SameLine();
ImGui::TextLinkOpenURL(oxorany("GOAT XITERS"), oxorany("https://discord.gg/S9gQAmCMN"));
ImGui::TextDisabled(oxorany("CHANNEL:"));
ImGui::SameLine();
ImGui::TextLinkOpenURL(oxorany("MY CHANNEL"), oxorany("https://discord.gg/S9gQAmCMN"));
ImGui::SameLine();
ImGui::TextLinkOpenURL(oxorany("MY Chat"), oxorany("https://discord.gg/S9gQAmCMN"));
ImGui::Spacing();
ImGui::EndTabItem();
}
